...
if __name__ == '__main__':
	...
	if len(sys.argv) > 1:
		...
		parser.add_argument("-u", "--url", dest="archives_url", help="Adress to investigate")
		parser.add_argument("-x", "--xss", dest="xss", action="store_true",default=False, help="Perform XSS attacks")
		parser.add_argument("-d", "--spider", dest="spider", help="Look for every files")
